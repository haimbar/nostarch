...
\NewDocumentCommand{\likelst}{m}{\texttt{#1}}
...
\RenewDocumentCommand{\showCode}{m m O{} O{}}{% \-\\
  \IfFileExists{#2}{
    ...
    \ifminted
    \inputminted[firstline=#3, lastline=#4, firstnumber=1]{text}{#2}
    \ifreducedspace
      \vspace{-\medskipamount}
      \vspace{-\baselineskip}
    \fi
    \else
      \iflistings
      \lstinputlisting[firstline=#3, lastline=#4]{#2}
      \else
