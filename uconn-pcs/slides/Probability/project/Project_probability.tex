...
\item In a game of poker, find the probability that a five-card hand contains
  \begin{enumerate}[(a)]
  \item a straight (excluding royal flush and straight flush),
  \item four of a kind,
  \item a full house (three cards of one value and two cards of
    another value)?
  \item a flush,
  \item one pair,
  \item two pairs,
