...
\begin{center}\Large\bf
  Homework 2\\ Data Science\\ PCS – Uconn, 2023\\
  Due Date: June 28\\ (by 8pm, via HuskyCT)
\end{center}
...
%   \end{enumerate}
\item Using simulation to find the probability that at least will win more than
  ...
  replacement. 
\item We have twenty-four students and three professors in our class, so there
  are 27 people in our class. Suppose that each year has 365 days. Use
  simulation to find the probability of the following event.
\begin{enumerate}
\item \emph{Exactly two} out of twenty-seven people have the same birthday and
