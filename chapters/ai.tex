...
understanding whether those steps make sense. An AI tool can write a command,
fit a model, or describe a graph, but it does not reliably know what question
you should ask or what the variables in your dataset really measure. It can
also miss an important source of bias or use a method whose assumptions do not
fit the data.

For example, suppose you ask an AI tool to find out whether one group of
people has a higher average than another. It might immediately choose a test,
run the calculation, and report a small $p$-value. But it might not notice
that the groups were formed by a biased sampling process, that the variable
was measured differently in the two groups, or that the question is about a
causal effect rather than an association. The calculation can be correct while
the conclusion is still misleading.

Your first responsibility is to define the question and understand the data
before asking AI to help. You need to decide who the population is, what the
sample represents, how each variable was measured, and what outcome would
actually answer the question. These decisions come from the subject matter and
the way the dataset was collected, not from fluent wording or a clever prompt.

Your second responsibility is to check the analysis and judge the conclusion.
The ideas in this book give you a way to do that: examine the data, check the
assumptions, verify the calculations, and distinguish an association from a
causal claim. AI can make the work faster, but learning these ideas is what
lets you recognize a plausible-looking mistake and explain why an answer can
