...
Jordan Ellenberg poses the question:
 `\textit{Why are handsome men are such jerks?}' \citep{ellenberg2015not}.
...
points in this region, but we never observe them. They include some very bad
books that were turned into very good movies.
