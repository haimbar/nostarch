...
\hypertarget{ch:data}{%
\section{Base-Rate Fallacy}\label{base-rate}}
...
whether the the person detained by the police (Teddy) is the real perpetrator.

\showCode{R}{Code/datacollect-baserate.R} %

The number of time that Teddy was, in fact, the perpetrator is 
...
It is related to Bayes' theorem which we've encountered in Chapter \ref{ch:probability}. 
...
in some case, with severe consequences.)
