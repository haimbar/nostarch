...
test's high accurate, the data collected is of good quality, so the prosecutor
claims that Teddy is the burglar with a probability of 0.95 (95\%). This seems
convening because the test is wrong only 5\% of the times, but the probability
