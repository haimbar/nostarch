\chapter{Data Collection: Cathing the Right Data in the Wild}\label{ch:data}
...
\begin{example}[hit aircraft\index{bias!Survival Bias!hit aircraft}]
...
appeared in Chapter~\ref{ch:EDA}, Figures~\ref{fig:ch2:sidebysidebp} and 
\ref{fig:ch2:scatter}. There, the variables where \code{x} (e.g., time) and
...
The second example appeared in Chapter~\ref{sec:simpsons-paradox}, where we
...
\wingding{5}\wingding{6}\wingding{7} to interpolate the data at more dense,
