...
% \runR{Code/datacollect-goodbadsample.R}{datacollect-goodbadsample}[run]
...
\hypertarget{ch:data}{%
\subsection{A representative sample is more useful than a larger sample}\label{representative}}
