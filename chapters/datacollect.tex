...
\why{This may fit the probability chapter?}

The \emph{base-rate fallacy} is a common source of misconceptions and
misinterpretations of data.  Consider the following example:

A pet store owner discovers a break-in and a stolen parakeet. The police respond and find two things: Teddy walking nearby and, separately, drops of human blood in the store. Teddy appears suspicious to the police (though he does not have the parakeet), so they detain him and test his blood. The lab finds that both the blood at the scene and Teddy’s blood type are $B-$. The police immediately arrest Teddy for the burglary.
...
\item If a person's blood type is not $B-$, the test correctly identifies this 95\% of the time.
\end{itemize}

Because the test is highly accurate, the prosecutor claims the chance that Teddy
is the burglar is 0.95 (95\%). At first glance, this is convincing—after all,
...
blood. Let’s examine whether the prosecutor’s claim holds up, by simulation.
