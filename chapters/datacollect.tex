...
\begin{figure}[H]
  \includegraphics[width=.6\textwidth]{images/chapter_7/extra2.pdf}
  \caption{The relationship between \code{x} and \code{y} for three different
  functions. Between 0 and 0.4, the three functions are similar, but after
...
correct. For example, suppose that \code{y} in the data in Figure~\ref{fig:ch7:ext1}
represents the average monthly amount spent on online shopping in thousands of dollars,
and \code{x} represents their annual income (in \$100,000). In our original sample
which gave us Figure~\ref{fig:ch7:ext1}, we only had people who spend between 0 and \$300
