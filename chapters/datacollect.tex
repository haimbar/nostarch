...
\jy{Is `hypertarget` necessary? Seems not. Could do a global
  cleaning.}

\hypertarget{representative}{%
\section{Representative Sample}\label{representative}}
\hypertarget{keyterms}{%
...
of the population and as such, estimates of population features based
...
\hypertarget{representative-size}{%
...
\hypertarget{types-data-problems}{%
...
people, so what we see are only those with the best reviews. If a book is
