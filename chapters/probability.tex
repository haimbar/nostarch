...
\item Probability: assuming that all the elements of the sample space have
...
As seen from Figure~\ref{fig:probability-simpson},
for the whole data, $y$ has an increase pattern as $x$
