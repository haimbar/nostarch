...
Running the above code should give the approximate probability that the other
coin in the box is also a gold coin as
...
In \wingding{1}, the \code{lm} function is used to fit a linear trend. Don’t
worry about the details yet -- we will cover them in Chapter TBA.
