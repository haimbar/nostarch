...
How tall are 12‑year‑old boys, on average? You could measure a few hundred,
but you cannot measure them all. Still, governments, scientists, and
businesses make such guesses every day. They use limited data to learn about
hidden quantities—averages, percentages, or relationships.

Estimation is the art of making good guesses from partial information. Think
of it as a hide‑and‑seek game: the truth is hidden, and the sample gives
clues. In the previous chapter we asked whether an observed effect could be
explained by chance. Here we ask a different question: if a quantity exists,
how can we estimate it, and how confident should we be in that estimate?

This chapter shows practical strategies: computing point estimates, comparing
estimators, learning the idea behind maximum likelihood, and quantifying
uncertainty with confidence intervals and resampling.
