...
$E[(\hat\theta - theta)^2]$, is the \emph{mean squared error (MSE)}\index{mean
...
through optmizing an objective function or solving some estimating
...
\emph{Bootstrap}\index{bootstrap} is a powerful tool to approximate the
...
\begin{example}[Bootstrap approximation of variance]
