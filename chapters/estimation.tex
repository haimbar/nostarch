...
Which of the three estimator is the best? In this game, the Nature knows the truexs
...
It is desirable to adapt the \lstinline{do1rep} function to make it
capable of taking an arbitary distribution as input to generate data.
...
data generating scheme is. Such estimator may not, however, always exist.
...
the log transformation is monotonely increasing, the solution is the
same when we maximize the loglikelihood.
