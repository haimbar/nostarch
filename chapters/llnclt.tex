...
several orders of magnitude so the convergence\index{convergence} is easy to see. We will generate
...
\ref{fig:ch4:LLNdemoPoisson} shows the results.
...
the average converges to 12*10=120 messages per day.
...
\ref{fig:ch4:CLTexp2} shows the results for $n=50$ (left) and $n=500$ (right).
