...
Hypothesis testing is a framework scientists and decision-makers use to 
...
randomly, this test statistic follows a \why{readers may not know this} hypergeometric distribution. The 
...
such that \(n/2\) are \why{tea-first cups?} correctly chosen is:
\[
