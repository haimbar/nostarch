...
hand---ike a courtroom verdict, but with fewer objections and more
statistics.
...
hypothesis}, $H_1$, which is the claim we hope to support in a
...
course, this decision-making process isn’t foolproof; we might make errors. 
...
$\alpha$. A \emph{Type II error} arises when we fail to reject $H_0$ even 
...
its ability to detect an effect when it exists.
